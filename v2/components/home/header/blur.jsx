const Blur = () => {
  return (
    <>
      {/* <div className="absolute bottom-0  lg:-bottom-10 h-[12.5rem] w-[12.5rem] lg:h-[21.875rem] lg:w-[21.875rem] xl:h-[21.25rem] xl:w-[44.25rem] rounded-tr-full rounded-tl-full bg-gradient-to-r from-red-400 to-red-700 blur-3xl filter hidden dark:block lg:opacity-20"></div> */}
