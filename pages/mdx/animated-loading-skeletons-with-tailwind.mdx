...
description: "An animated loading skeletons can make your website so much meanfull when it comes to data fetching from API."
publishedAt: "2022-07-18"
status: "published"
tags: [Animation, Loading, Skeleton, TailwindCss, css]
bannerUrl: /blogs/animated-skeleton.jpg
blurHash: "L2Rysg%Mt7xu_3fQfQfQ4nj[WBof"
series:
  order: 1
  title: "Quick Tip"
---
...
<div className="grid grid-cols-2 gap-6 sm:grid-cols-3">
  ...
  <div>{/* <LoadingSkeleton /> */}</div>
  <div className="hidden sm:block">{/* <LoadingSkeleton /> */}</div>
</div>
