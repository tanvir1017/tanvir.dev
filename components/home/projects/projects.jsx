    ...
    <section className=" max-w-6xl mx-auto relative md:px-0 px-3 md:mt-0 mt-12">
      <div className="flex md:flex-row flex-col items-end justify-between">
        <div className="max-w-2xl">
          ...
          <div className="md:hidden flex items-center justify-between mb-4">
            <h2 className="md:text-4xl text-2xl font-firaSansExtraBold dark:text-white text-gray-600  tracking-wider uppercase">
              Projects
            </h2>
      ...
      <div className="grid md:grid-cols-3 place-items-center md:mt-36 mt-10">
        <div className="-rotate-90 md:block hidden">
          <h2 className="cursor-pointer stroke-text-light dark:stroke-text-dark hover:stroke-text-light-gradient dark:hover:stroke-text-dark-gradient hover:opacity-100 md:text-9xl text-6xl  uppercase font-poppinsBlackItalic tracking-wider opacity-10 text-[#0605051a]">
            Projects
          </h2>
        </div>
